...
import os
os.environ["TENSORBOARD_LOGGING_DIR"] = "logs/Qwen3-8B"
...
# 2、构造SFTConfig实例
config = SFTConfig(
    output_dir="./finetuned/Qwen3-8B-SFT",
...
# 3、加载模型和tokenizer
model = AutoModelForCausalLM.from_pretrained(r"model/Qwen3-8B/")
tokenizer = AutoTokenizer.from_pretrained(r"model/Qwen3-8B/")
...
trainer.save_model("./finetuned/Qwen3-8B-SFT")
